...
func muxRouter(opts Options, rc redis.UniversalClient, inspector *asynq.Inspector) *mux.Router {
	...
	api.HandleFunc("/queues/{qname}/active_tasks/cancel/{task_id}", newCancelActiveTaskHandlerFunc(inspector)).Methods("POST")
	...
	api.HandleFunc("/queues/{qname}/pending_tasks/delete/{task_id}", newDeleteTaskHandlerFunc(inspector)).Methods("DELETE")
	...
	api.HandleFunc("/queues/{qname}/pending_tasks/archive/{task_id}", newArchiveTaskHandlerFunc(inspector)).Methods("POST")
	...
	api.HandleFunc("/queues/{qname}/scheduled_tasks/delete/{task_id}", newDeleteTaskHandlerFunc(inspector)).Methods("DELETE")
	...
	api.HandleFunc("/queues/{qname}/scheduled_tasks/run/{task_id}", newRunTaskHandlerFunc(inspector)).Methods("POST")
	...
	api.HandleFunc("/queues/{qname}/scheduled_tasks/archive/{task_id}", newArchiveTaskHandlerFunc(inspector)).Methods("POST")
	...
	api.HandleFunc("/queues/{qname}/retry_tasks/delete/{task_id}", newDeleteTaskHandlerFunc(inspector)).Methods("DELETE")
	...
	api.HandleFunc("/queues/{qname}/retry_tasks/run/{task_id}", newRunTaskHandlerFunc(inspector)).Methods("POST")
	...
	api.HandleFunc("/queues/{qname}/retry_tasks/archive/{task_id}", newArchiveTaskHandlerFunc(inspector)).Methods("POST")
	...
	api.HandleFunc("/queues/{qname}/archived_tasks/delete/{task_id}", newDeleteTaskHandlerFunc(inspector)).Methods("DELETE")
	...
	api.HandleFunc("/queues/{qname}/archived_tasks/run/{task_id}", newRunTaskHandlerFunc(inspector)).Methods("POST")
	...
	api.HandleFunc("/queues/{qname}/completed_tasks/delete/{task_id}", newDeleteTaskHandlerFunc(inspector)).Methods("DELETE")
